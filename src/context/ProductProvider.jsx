...
function ProductProvider({ children }) {
  ...
  const addProduct = (productToAdd) => {
    const existingProduct = selectedProducts.find(product => product.id === productToAdd.id);
      ...
      const updatedProducts = selectedProducts.map(product => {
        if (product.id === productToAdd.id) {
          return {
            ...
            totalPrice: product.totalPrice + (productToAdd.quantity * productToAdd.price)
          };
        }
       return product;
      });
  ...
  return (
    <ProductContext.Provider value={{ selectedProducts, addProduct, updateQuantity }}>
      {children}
